extension Hook {
    ...
    @available(
        *,
        deprecated,
        renamed: "HookState",
        message: "Use top-level 'HookState'."
    )
...
extension HookState {
    ...
    @available(
        *,
        ...
        renamed: "failed",
        message: """
        Use 'failed' instead. The state no longer carries an associated error—handle errors \
